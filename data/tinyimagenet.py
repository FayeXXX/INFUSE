...
def get_tiny_image_net_datasets_20(train_transform, test_transform, train_classes=range(20),
                       open_set_classes=range(20, 40), balance_open_set_eval=False, split_train_val=True, seed=0):
...
def get_tiny_image_net_datasets_60(train_transform, test_transform, train_classes=range(20),
                       open_set_classes=range(20, 80), balance_open_set_eval=False, split_train_val=True, seed=0):
...
def get_tiny_image_net_datasets_100(train_transform, test_transform, train_classes=range(20),
                       open_set_classes=range(20, 120), balance_open_set_eval=False, split_train_val=True, seed=0):
...
def get_tiny_image_net_datasets_140(train_transform, test_transform, train_classes=range(20),
                       open_set_classes=range(20, 160), balance_open_set_eval=False, split_train_val=True, seed=0):
...
if __name__ == '__main__':
    create_val_img_folder('/home/xyf/dataset/OSR/tiny-imagenet-200')
